...
# print(dir(new_list))
#
# # when we see output of dir(list) it will contain __iter__ only which means that we can do only iteration on it.
...
#     print(j)
#
# iterators must have two methods iter and next
class MyRange:
    def __init__(self, start, end):
        self.value = start
        self.end = end
